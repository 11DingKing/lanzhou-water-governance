...
func ManifestRegionsValid(m Manifest) bool { return m.ProducerRegion != m.FacilityRegion }
...
func RegionPairValid(producer, carrier, facility string) bool {
	return producer != facility && carrier != facility
}
